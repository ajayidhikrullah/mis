        ...
        <div class="col-6">    
            ...
            <form method="POST" action="{{route('tutors.store')}}">
                <div class="form-group">
                    ...
                    <input type="text" name="tutor_full_name" value="{{old('')  ?? }}" class="form-control" id="full_name" placeholder="type in tutors full name">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tutor_email" value="{{old('')  ?? }}" id="email" aria-describedby="email" placeholder="Enter tutors email">
                ...
                <label for="phone">Phone</label>
                    <input type="text" class="form-control" name="tutor_phone" id="phone" aria-describedby="phone" placeholder="Enter tutors Phone">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tutor_address" id="address" aria-describedby="address" placeholder="Enter tutor address">
